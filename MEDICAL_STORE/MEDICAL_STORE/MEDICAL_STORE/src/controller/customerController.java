...
public class customerController {
    ...
    private void initialize() throws SQLException {
        ...
        ResultSet resultSet = DataManager.getInstance().getAllmedicine();
        medicine_nameField.setText("");
    ...
    public void search(final ActionEvent actionEvent) throws SQLException {
        ...
        searchParametes.add(iddField.getText());
        searchParametes.add(medicine_nameField.getText());
        ...
        searchParametes.add(strengthField.getText());
        searchParametes.add(supplierName.getText());
        searchParametes.add(manfacturerNameField.getText()); 

        ResultSet resultSet = DataManager.getInstance().searchFormedicine(searchParametes);
        showDatainTableView(resultSet);
    }
    ...
    public void CheckOut(final ActionEvent actionEvent) {
        ...
        if(nonEmpty() && followPattern()){
            CheckOutController checkOutController = new CheckOutController(CardController.medicineQuantityHashMap, CreditNumberField.getText(), CVVField.getText(), getDate(ExpireDateField.getText()), testLabel);
